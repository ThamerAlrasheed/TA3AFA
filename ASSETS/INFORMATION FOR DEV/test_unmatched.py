...
# See which manufacturers exist in MOH
print("Manufacturers in MOH matching our keys:")
for c in medications.keys():
    matches = moh_df[moh_df['MANUFACTURER_CLEAN'].str.contains(c)]
    print(f"{c}: {len(matches)} rows")
